...
export const FaqPage = () => {
    ...
    const faqItems: FaqUIEntry[] = [
        {question: "Our project wants to join Talko and start minting sNFT awards. How can we do it?", answer: <>Talko has been recently updated to support awards for multiple projects. Get in touch with us at <a href="mailto:info@talkoapp.io">info@talkoapp.io</a> if you are interested.</>},
